...
function ReplyItem({
  ...
  const authorImage = reply.author.image || "/images/txt_img.png";
  ...
  return (
    <div className="flex gap-2.5 mb-3">
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-(--comment-bg) rounded-xl p-2.5">
...
function CommentItem({
  ...
  const authorImage = comment.author.image || "/images/txt_img.png";
    ...
    <div className="flex gap-3 mb-4">
      ...
      <div className="flex-1 min-w-0">
        <div className="bg-(--comment-bg) rounded-xl p-3">
          ...
          <p className="text-sm text-(--color7)">{comment.content}</p>
        </div>
        <div className="flex items-center gap-3 mt-1 px-1">
          <div className="relative group">
            <div className="absolute bottom-full left-0 mb-1 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
...
function FeedPostCard({ post, currentUserId }: { post: Post; currentUserId?: string }) {
