  ...
  return (
    ...
    >
      <button
        onClick={toggleTheme}
        type="button"
        className={`${theme === "dark" ? "bg-transparent" : "bg-(--color5)"} border border-(--color5) rounded-full w-16.5 h-8 flex items-center relative outline-none rotate-90 transition-none shadow-[0_0_10px_rgba(24,144,255,0.4)]`}
      ...
      >
        ...
        >
          <div className="bg-white rounded-full w-4.5 h-4.5 shadow-md"></div>
        </div>
